...
class SettingsService
{
    ...
    private function seedDefaults(): void
    {
        $defaults = [
            ...
            'student_id_template_mode'  => ['value' => 'default', 'type' => 'string', 'desc' => 'Choose the built-in or custom student ID background design'],
            'student_id_front_template' => ['value' => '', 'type' => 'image', 'desc' => 'Background-only template for the front of student IDs'],
            'student_id_back_template'  => ['value' => '', 'type' => 'image', 'desc' => 'Background-only template for the back of student IDs'],
