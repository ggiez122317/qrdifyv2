...
export default function EditTeacherPage() {
      ...
      try {
        ...
        if (res.data) {
          ...
          setFormData({
            ...
            email: data.email || '',
            phone: data.teacher_profile?.contact_number || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('toast_message', 'Teacher record updated successfully');
      ...
      <div className="max-w-[1400px] mx-auto w-full flex flex-col lg:flex-row gap-8 h-[calc(100vh-6rem)]">
        ...
        <div className="flex flex-col flex-1 min-w-0 h-full">
          ...
          <div className="flex items-center gap-4 mb-6 shrink-0">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Edit Teacher Record</h2>
              <p className="text-slate-500 text-sm mt-1 font-medium">Update the teacher&apos;s record and preview changes in real-time.</p>
            </div>
          </div>
